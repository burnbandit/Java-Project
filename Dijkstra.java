...
public class Dijkstra {
  ...
  public void computeAllEuclideanDistances() 
  {
        for (Vertex vertex : getVertices() )
        {
            ...
            {
                edge.distance = computeEuclideanDistance
       ...
       l.add(getVertex(s));
        ...
        while(l.isEmpty() ==false)
        {
            ...
            for (Edge e: v.adjacentEdges)
            {
                ...
                if(v2.known==false)
                {
                    Double dis = e.distance;
                    double dis2 = v.distance + dis;
                    if (v2.distance > dis2)
                    {
                        v2.distance = dis2;
                        v2.prev = v;
  ...
  public List<Edge> getDijkstraPath(String s, String t)
  {
        ...
        {
            path.addFirst(new Edge(
                  v.prev, v,computeEuclideanDistance(v.prev.x, v.prev.y, v.x, v.y)));
        }
        return path;
  }
